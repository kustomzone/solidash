...
class NoteComponent extends LitElement {
  ...
  render() {
    return html`
    <bs-button primary id="modalLauncher" @click=${this.modalOpen}>New Note</bs-button primary>
    ...
    <editor-component name="EditorNote" uri=${this.uri}></editor-component>
